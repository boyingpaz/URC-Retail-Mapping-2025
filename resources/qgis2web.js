...
map.getView().fit([13432157.829944, 1612826.221395, 13513922.906863, 1665876.862508], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">URC 2025 Retail Store Mapping</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_MetroManilaCityBoundaries_1,
    colName: 'CITY_MUNI',
    zoom: 10,
    collapsed: true,
    map: map
